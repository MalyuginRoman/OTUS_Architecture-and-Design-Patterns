...
void ExceptionHandler::executeRepeat(ExceptionHandler* handler, SafeQueue *cmd, std::exception ex)
{
...
void ExceptionHandler::executeWrite(SafeQueue *cmd, std::exception ex)
{
